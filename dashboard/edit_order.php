        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                if(isset($_POST['update'])){
                    ...
                    $edit_order_sql = "update checkout set status='$status' where id='$id'";
                    $edit_order_query = mysqli_query($connection, $edit_order_sql);

                    if($edit_order_query){
                        echo "Order has been updated to: ". $status;
                    }else{
...
?>
                ...
                <form action="edit_order.php?edit=<?php echo $id; ?>" method="post">
